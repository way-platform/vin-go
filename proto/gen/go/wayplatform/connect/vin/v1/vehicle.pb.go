...
func (x *Vehicle) HasVehicleType() bool {
	if x == nil {
		return false
	}
...
func (x *Vehicle) ClearVehicleType() {
	protoimpl.X.ClearPresent(&(x.XXX_presence[0]), 1)
	x.xxx_hidden_VehicleType = VehicleType_VEHICLE_TYPE_UNSPECIFIED
}
...
var file_wayplatform_connect_vin_v1_vehicle_proto_depIdxs = []int32{
	...
	2, // 1: wayplatform.connect.vin.v1.Vehicle.vehicle_type:type_name -> wayplatform.connect.vin.v1.VehicleType
