...
func DecodeVehicle(vin string) (*vinv1.Vehicle, bool) {
	...
	switch wmi {
	// Mercedes-Benz
	case "VSA", "WDB", "WDF", "W1T", "W1V", "W1W", "W1X", "W1Y", "W1Z",
		"WD3", "WD4", "WDA", "WDZ", "1MB",
		"8AB", "8AC", "8BN", "8BR", "8BT", "8BU", "9BM":
	...
	// "Dodge (2003-2005) or Freightliner (2002-2005)"
	// Defaulting to Dodge as it's often the primary consumer association for T1N Sprinters in NA,
	...
	// 2. Determine Model from positions 4-6
	modelCode := vin[3:6]
	...
	if vehicleType == vinv1.VehicleType_VEHICLE_TYPE_UNSPECIFIED {
		switch wmi {
		// HGV Context
		case "W1T", "W1H", "WD6", "WDY", "W2Y", "1MB", "9BM":
			vehicleType = vinv1.VehicleType_HEAVY_GOODS_VEHICLE
		...
		// MPV
		case "W1W", "WD4", "WD5", "WD8", "WDR", "W2W", "8BT":
